...
import { SERVER_SIGNAL, ServerStatus } from '../typesOld/base/serverStatus';
import { RawAllocation, RawAllocationList } from '../typesOld/user/networking';
import { RawEgg } from '../typesOld/user/egg';
import { RawEggVariableList } from '../typesOld/user/eggVariable';
import { RawFile, RawFileList } from '../typesOld/user/file';
import { RawServer, ServerAttributes } from '../typesOld/user/server';
import { RawBackup, RawBackupList } from '../typesOld/user/serverBackup';
import { RawServerDatabase, RawServerDatabaseList } from '../typesOld/user/serverDatabase';
import { RawServerSchedule, RawServerScheduleList } from '../typesOld/user/serverSchedule';
import { RawServerSubuser, RawServerSubuserList } from '../typesOld/user/serverSubuser';
